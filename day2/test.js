...
const DAY_INPUT = `Game 1: 4 red, 5 blue, 9 green; 7 green, 7 blue, 3 red; 16 red, 7 blue, 3 green; 11 green, 11 blue, 6 red; 12 red, 14 blue
...
describe('Day 2: Cube Conundrum', () => {
    it('works on part 1', () => {
        ...
        assert.strictEqual(part1(input, cubes), 8)
    });
